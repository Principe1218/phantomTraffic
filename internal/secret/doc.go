...
// json.Marshaler, and yaml.Marshaler — so a credential can never be formatted
// into a log line. Secrets are resolved lazily inside handlers via a
// CredentialSource; engine and behavior hold only the interface and a ref.
//
